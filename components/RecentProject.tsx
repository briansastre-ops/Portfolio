    ...
    <div className='py-20' id='projects'>
      ...
      <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
        {projects.map(({ id, title, img, des, iconLists, link }) => (
          <div 
            key={id} 
            className="sm:h-[30rem] h-[24rem] lg:min-h-[28rem] flex items-center justify-center sm:w-80 w-[70vw] mt-10"
          >
            <a 
              href={link} 
              target="_blank" 
              rel="noopener noreferrer" 
              className="w-full h-full flex flex-col justify-between" // Added flex-col and justify-between
            >
